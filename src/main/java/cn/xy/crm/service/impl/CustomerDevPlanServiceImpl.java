...
import cn.xy.crm.mapper.CustomerDevPlanMapper;
import cn.xy.crm.page.PageResult;
import cn.xy.crm.query.CustomerDevPlanQueryObject;
import cn.xy.crm.query.QueryObject;
import cn.xy.crm.service.ICustomerDevPlanService;
...
public class CustomerDevPlanServiceImpl implements ICustomerDevPlanService {
    ...
    public PageResult queryDevPlanByCondition(QueryObject qo) {
        // 市场主管可以查看所有正式客户开发计划
        if (PermissionUtils.checkPermission("cn.xy.crm.web.controller.CustomerDevPlanController:ALL")) {
